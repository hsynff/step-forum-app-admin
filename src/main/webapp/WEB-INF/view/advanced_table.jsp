...
<body>
  ...
  <script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/resources/lib/advanced-datatable/js/jquery.js"></script>
  ...
  <script type="text/javascript" language="javascript" src="${pageContext.request.contextPath}/resources/lib/advanced-datatable/js/jquery.dataTables.js"></script>
  <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/advanced-datatable/js/DT_bootstrap.js"></script>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      nCloneTd.innerHTML = '<img src="${pageContext.request.contextPath}/resources/lib/advanced-datatable/images/details_open.png">';
      ...
      $('#hidden-table-info tbody td img').live('click', function() {
        ...
        if (oTable.fnIsOpen(nTr)) {
          ...
          this.src = "${pageContext.request.contextPath}/resources/lib/advanced-datatable/images/details_open.png";
          oTable.fnClose(nTr);
        } else {
          /* Open this row */
          this.src = "${pageContext.request.contextPath}/resources/lib/advanced-datatable/images/details_close.png";
